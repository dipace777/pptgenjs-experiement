...
export function PresentationMode({
  ...
  useLayoutEffect(() => {
    ...
    const measure = () => {
      ...
      const byWidth = { width: clientWidth, height: clientWidth / SLIDE_ASPECT };
      const next =
  ...
  return (
    <div ref={rootRef} style={presentStyles.root}>
      {slide && fit.width > 0 ? (
        <div style={{ ...presentStyles.stageWrap, width: fit.width, height: fit.height }}>
          <KonvaSlide
            slide={slide}
            width={fit.width}
            height={fit.height}
      ...
      >
        ...
        <button
          type="button"
          style={{ ...presentStyles.controlButton, ...presentStyles.exitButton }}
          onClick={onClose}
